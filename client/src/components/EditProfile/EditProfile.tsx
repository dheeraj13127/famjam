            ...
            <Grid className="editProfileColumn">
              ...
              <Grid.Row centered stretched>
                <Grid.Column textAlign="center" computer={16}>
                  ...
                  <div>
                    <Button
                      onClick={modifyShowAvatar}
                      className="editProfileSelectAvatarbtn"
                    >
                      {showAvatar ? "Done" : `Change Avatar`}
                    </Button>
                  </div>
                </Grid.Column>
              </Grid.Row>
              ...
              <Grid.Row>
                <Grid.Column textAlign="center">
                  ...
                  {!enableInput ? (
                    <Button
                      className="userNameEditBtn"
                      onClick={() => activateEnableInput("inactive")}
                    >
                      Done
                    </Button>
                  ) : (
                    <Button
                      className="userNameEditBtn"
                      icon
                      onClick={() => activateEnableInput("active")}
                    >

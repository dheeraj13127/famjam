  ...
  return (
    <div>
      ...
      <Sidebar.Pushable className="mobile hidden tablet hidden dashboardSidebarBox">
        <LeftSideBar onlineUsers={props.onlineUsers} closeLeftSidebar={closeLeftSidebar}  setActivateMessage={props.setActivateMessage}  conversations={props.conversations} visible={visible} userData={props.userData} message={props.message} setMessage={props.setMessage} />
